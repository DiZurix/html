function sign_up() {
  ...
  document.querySelector('.btn_sign').innerHTML = "INSCRIPTION";
  document.querySelector('.btn_sign').style.left = "-2px";
  setTimeout(function () {
...
function sign_in() {
  ...
  document.querySelector('.btn_sign').innerHTML = "CONNEXION";
  document.querySelector('.btn_sign').style.left = "0px";
}
